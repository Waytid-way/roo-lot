...
*(รูปที่ 4.1: การกระจายตัวของปริมาณการใช้ไฟฟ้า)*

**สังเกต**:
- ข้อมูลมีการแจกแจงแบบเบ้ขวา (Right-skewed) โดยส่วนใหญ่บ้านจะใช้ไฟในช่วง 5-15 kWh ต่อเดือน (เฉลี่ย)
- มีข้อมูลบางส่วนที่ใช้ไฟสูงผิดปกติ (Outliers) ซึ่งอาจเป็นบ้านขนาดใหญ่

**4.1.2 Correlation Matrix**

![Correlation Heatmap](./outputs/eda/eda_correlation.png)
*(รูปที่ 4.2: ความสัมพันธ์ระหว่างตัวแปร)*

**สังเกต**:
- `household_size` มีความสัมพันธ์เชิงบวกกับ `energy_consumption` สูงมาก (0.89)
- `has_ac` มีความสัมพันธ์ทางบวกปานกลาง (0.35)
- `avg_temperature` และ `random_date` ไม่มีความสัมพันธ์ที่ชัดเจนกับค่าไฟในชุดข้อมูลนี้

**4.1.3 Feature vs Target Relationships**

![Feature Relationships](./outputs/eda/eda_feature_relationships.png)
*(รูปที่ 4.3: ความสัมพันธ์ระหว่าง Feature หลักกับค่าไฟ)*

- **Household Size**: เห็นแนวโน้มชัดเจนว่ายิ่งคนเยอะ ค่าไฟยิ่งสูงแบบ Linear
- **Has AC**: กล่อง Boxplot แสดงให้เห็นว่าบ้านที่มีแอร์มีค่ามัธยฐาน (Median) ของการใช้ไฟสูงกว่าบ้านที่ไม่มีแอร์อย่างมีนัยสำคัญ
...
*(รูปที่ 4.4: กราฟเปรียบเทียบค่าจริงกับค่าที่ทำนายได้)*

เกาะกลุ่มกันแน่นตามแนวเส้นทะแยงมุม แสดงถึงความแม่นยำที่สูง (High R²)

**4.3.2 Residual Analysis**

![Residual Plot](./outputs/model_viz/residual_plot.png)
*(รูปที่ 4.5: Residual Plot)*

![Residual Distribution](./outputs/model_viz/residual_dist.png)
*(รูปที่ 4.6: การกระจายตัวของค่าความคลาดเคลื่อน)*

**วิเคราะห์ผล (Interpretation)**:
